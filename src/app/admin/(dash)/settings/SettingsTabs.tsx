...
import { CheckCircle2, DatabaseBackup, Loader2, Save, ShieldAlert } from "lucide-react";
import { api } from "@/lib/client";
import { PasswordInput } from "@/components/PasswordInput";
import type { BusinessSettings, SeoSettings, BackupSettings } from "@/lib/settings";

type Tab = "business" | "seo" | "backup";
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="field-hint">
                Just the headline number shown on the storefront — the real payment
                credentials live under Payment Accounts.
              </p>
            </div>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
